...
// 받아온 정보들을 DB에 넣어준다
    sqlQuery = " INSERT INTO product(pcode, pname, description, price, continents, images) VALUES (CREATE_PCODE_FC(), ?, ?, ?, ?, ?) ";
    data = [req.body.pname, req.body.description, req.body.price ,req.body.continents, req.body.images ];
