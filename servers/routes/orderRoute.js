...
const {result, makingInsertQuestionMark, makingUpdateQuestionMark, formatArrayQueryArrayData, matchingBodyNColumnData} = require("../common/db_common")
    ...
    db.getConnection((err, connection)=>{
        try{
            ...
            sql = connection.query(sqlQuery, (err, row)=>{
                ...
                let column1 = ["ocode", "totalQuantity", "totalPrice", "ph", "recipient", "zonecode", "address", "detailAddress", "usePoint", "method", "cid"];
                ...
                let data = [matchingBodyNColumnData(column1, req.body, {dataName: ["ocode", "cid"], value: [ocode, req.user.cid]})];
                ...
                buyingList.map( product =>{
                    ...
                    data.push(
                        matchingBodyNColumnData(column2, product, {
                            dataName: ["ocode", "cid", "price"],
                            value: [ocode, req.user.cid, (product.price * product.quantity)]
                            }
                        )
                    );
                ...
                data.push( matchingBodyNColumnData(column3, req.body, { dataName: "point", value: req.body.usePoint }, req.user.cid) );
